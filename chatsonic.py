...
class Chatsonic:
  ...
  def conversation(self, input_text:str, language: str = "en", enable_google_results: bool = True, enable_memory: bool = True) -> str:
    ...
    if enable_memory:
      ...
      self.history_data.append({"is_sent": True, "message": input_text}, {"is_sent": False, "message": message})
